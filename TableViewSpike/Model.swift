// ALG: this code was copied from: https://github.com/smileyborg/TableViewCellWithAutoLayoutiOS8
...
class Model
{
    ...
    init()
    {
            for familyName in UIFont.familyNames {
              dataArray.append((title: familyName, body: randomLoremIpsum()))
            }
    }
    ...
    func randomLoremIpsum() -> String
    {
        ...
        let r = max(minimumNumberOfWords, Int(arc4random() % UInt32(loremIpsumArray.count))) // get a random number r, where:  minimumNumberOfWords <= r <= loremIpsumArray.count
